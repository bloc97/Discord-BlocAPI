 ...
 * @author bowen
 */
public class ProfileIconsDataCache extends ObjectCache {
    
    private static final long LIFE = TimeUnit.DAYS.toMillis(1);
    
    public final ProfileIconData profileIconData;
    
    public ProfileIconsDataCache(ProfileIconData profileIconData, Date currentDate) {
